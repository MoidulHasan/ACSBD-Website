  ...
  <div class="container sm:px-0 md:px-5 lg:px-7 xl:px-8">
    ...
    <div>
      ...
      <p class="mobile-subtitle subtitle lg:text-left xl:text-left pt-3">
        ...
        information you provide to enable us to process your orders swiftly.
      </p>
    </div>
    <div>
      ...
      <p class="mobile-subtitle subtitle lg:text-left xl:text-left pt-3">
        ...
        (if different), telephone number, mobile number, fax number, payment
        details, payment card details or bank account details. We will use the
        information you provide to enable us to process your orders swiftly and
        to provide you with the services and information offered through our
        website and which you request. <br />
        <br />
